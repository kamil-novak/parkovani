const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HUDMaterial.glsl-BvEi0gEL.js","./index-i1xHX9d5.js","./index-BVy-TfK5.css","./QueryEngine-B79VJ0Eh.js","./featureConversionUtils-1gMcYmRJ.js","./OptimizedFeature-D3320lj0.js","./OptimizedFeatureSet-Blu9Ckm7.js","./WhereClause-BJhvjWsn.js","./TimeOnly-Cs51moYZ.js","./timeSupport-CnXyY5Qx.js","./queryUtils-CwPqVSBK.js","./json-Wa8cmqdu.js","./QueryEngineCapabilities-DjYb9CEb.js","./utils-C3vuNDD-.js","./utils-CA7p_e2p.js","./utils-7hKZ6ZBe.js","./ClassBreaksDefinition-DrC74yjc.js","./PooledRBush-DtRx6CTi.js","./query-Bh9wQTG2.js","./pbfQueryUtils-iJCY45Wd.js","./pbf-C22yZSzm.js","./Indices-BtzNUPFJ.js","./glUtil-CakMA_Q2.js","./VertexElementDescriptor-BOD-G50G.js","./NormalAttribute.glsl-A_2ZufTM.js","./interfaces-DDtDqZYj.js","./VertexAttribute-BdZWZuT1.js","./basicInterfaces-CZwQPxTp.js","./NestedMap-GuqgquCN.js","./mat4f64-CSKppSlJ.js","./Util-Gk2XI9GV.js","./InterleavedLayout-BWMq8nIu.js","./BufferView-B9O7bAGv.js","./types-D0PSWh4d.js","./Octree-DunQF4_p.js","./sphere-T8qGINhP.js","./mat3f64-q3fE-ZOt.js","./plane-pI6IAlNJ.js","./quatf64-aQ5IuZRd.js","./IntersectorInterfaces-dI_rFEZm.js","./BufferObject-2Td0Kv4c.js","./boundedPlane-DECIyiSk.js","./lineSegment-VVJfBTQ_.js","./VertexArrayObject-BU_PqsFN.js","./doublePrecisionUtils-B0owpBza.js","./floatRGBA-CpVDYbaY.js","./renderState-kc7rtfiK.js","./projectVectorToVector-DGbRV3RB.js","./projectPointToVector-DVN8fluz.js","./computeTranslationToOriginAndRotation-ZlHqNFok.js","./MeshLocalVertexSpace-SY8G2dy-.js","./vec3f32-nZdmKIgz.js","./orientedBoundingBox-3eqgIjAg.js","./quat-CVl3iR4g.js","./spatialReferenceEllipsoidUtils-C156E205.js","./triangle-BmQuLC9l.js","./BindType-BmZEZMMh.js"])))=>i.map(i=>d[i]);
import{dV as si,ap as go,P as m,Q as B,X as ur,de as li,aX as N,iA as Dt,iK as Ft,iB as xo,eA as ve,ey as X,hp as Ge,iN as Qt,eF as ut,nF as To,bP as hr,c as ci,di,kF as _o,i7 as bo,bx as Rt,aY as It,bF as St,iv as de,gO as ye,iw as ae,ak as ui,iC as Je,iM as ht,en as Eo,ek as nt,lN as er,h3 as So,aJ as oe,qM as Te,ll as Co,cH as hi,cI as Ao,s as _e,gV as Le,g_ as Bt,aj as mi,_ as Tt,c2 as Ct,cY as fi,d0 as mt,d3 as Ie,d1 as ke,kC as wo,ib as Mo,k3 as Oe,fW as yo,iR as Oo,mB as Ro,gv as Io,qN as pe,c$ as Ze,kA as No,dQ as $o,fc as Ir,l6 as Lo,bs as rt,hn as it,al as Nr,qO as Po,ig as Do,ih as Fo,lq as Bo,d7 as zo,f2 as Ye,qP as Go,qQ as Vo,eo as Ot,aU as pi,aW as mr,qR as vi,qS as gi,el as $r,aT as Ho,gT as Uo,ej as Wo,iS as Lr,iT as jo,dU as qo,bt as ko}from"./index-i1xHX9d5.js";import{t as Yo}from"./requestImageUtils-CET72JOQ.js";import{s as be,i as ge,a as tr,O as rr,e as _t,n as zt,u as Ve}from"./basicInterfaces-CZwQPxTp.js";import{s as U}from"./Util-Gk2XI9GV.js";import{H as Xo}from"./InterleavedLayout-BWMq8nIu.js";import{n as fe,a as Q,t as Gt,S as xi,b as D,u as ft,c as Pr,o as kt,r as Zo}from"./NormalAttribute.glsl-A_2ZufTM.js";import{o as s,t as Qe,r as R}from"./interfaces-DDtDqZYj.js";import{e as f}from"./VertexAttribute-BdZWZuT1.js";import{a as I}from"./BindType-BmZEZMMh.js";import"./boundedPlane-DECIyiSk.js";import{E as Ti,U as xe}from"./sphere-T8qGINhP.js";import{B as Vt,o as Ko,g as Ht,r as Jo,c as Qo,p as ea,f as ta}from"./renderState-kc7rtfiK.js";import{e as bt,o as et}from"./mat3f64-q3fE-ZOt.js";import{e as fr,o as Dr}from"./mat4f64-CSKppSlJ.js";import{I as ra,L as ia}from"./orientedBoundingBox-3eqgIjAg.js";import{x as _i,c as Fr,y as oa,u as aa,q as na,i as Br}from"./BufferView-B9O7bAGv.js";import{o as sa,r as la}from"./doublePrecisionUtils-B0owpBza.js";function yl(t,e=!1){return t<=si?e?new Array(t).fill(0):new Array(t):new Float32Array(t)}function ca(t){t.vertex.code.add(s`
...
return posClip;
}`)}function He(t,e){Fa(t,e,new le("slicePlaneOrigin",(r,i)=>Ba(e,r,i)),new le("slicePlaneBasis1",(r,i)=>{var o;return Ur(e,r,i,(o=i.slicePlane)==null?void 0:o.basis1)}),new le("slicePlaneBasis2",(r,i)=>{var o;return Ur(e,r,i,(o=i.slicePlane)==null?void 0:o.basis2)}))}function Fa(t,e,...r){if(!e.hasSlicePlane){const n=s`#define rejectBySlice(_pos_) false
...
return proj * (view * vec4(pos, 1.0));
    ...
    }`)}const At=N();let gr=class extends K{constructor(e,r){super(e,"int",I.Pass,(i,o,a)=>i.setUniform1i(e,r(o,a)))}};function zi(t,e){e.hasSymbolColors?(t.include(ca),t.attributes.add(f.SYMBOLCOLOR,"vec4"),t.varyings.add("colorMixMode","mediump float"),t.vertex.code.add(s`int symbolColorMixMode;
vec4 getSymbolColor() {
...
}`)}function nc(t){t.uniforms.add(new k("screenSizePerspective",e=>Vi(e.screenSizePerspective)))}function Wa(t){t.uniforms.add(new k("screenSizePerspectiveAlignment",e=>Vi(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Vi(t){return X(ja,t.parameters.divisor,t.parameters.offset,t.minScaleFactor)}const ja=N();let te=class extends K{constructor(e,r){super(e,"vec4",I.Pass,(i,o,a)=>i.setUniform4fv(e,r(o,a)))}};function Hi(t,e){const r=t.vertex;e.hasVerticalOffset?(ka(r),e.hasScreenSizePerspective&&(t.include(Ua),Wa(r),gt(t.vertex,e)),r.code.add(s`
...
forwardTextureCoordinates();`),t.include(je,e),i.main.add(s`
          ...
          ${R(o,s`vec4 texColor = texture(tex, ${l?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}`);break;case D.Shadow:case D.ShadowHighlight:case D.ShadowExcludeHighlight:case D.ViewshedShadow:case D.ObjectAndLayerIdColor:We(r,e),t.include(Ue,e),t.include($e,e),t.include(lt,e),t.include(Xa,e),t.include(He,e),t.include(Ya,e),Ri(t),t.varyings.add("depth","float"),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),t.include(je,e),i.main.add(s`
          ...
          ${a===D.ObjectAndLayerIdColor?s`outputObjectAndLayerIdColor();`:s`outputDepth(depth);`}`);break;case D.Normal:{We(r,e),t.include(Ue,e),t.include(Gt,e),t.include(Si,e),t.include($e,e),t.include(lt,e),o&&i.uniforms.add(new Z("tex",u=>u.texture)),n===Q.ScreenDerivative&&t.varyings.add("vPositionView","vec3");const c=n===Q.Attribute||n===Q.Compressed;r.main.add(s`
          ...
          fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case D.Highlight:We(r,e),t.include(Ue,e),t.include($e,e),t.include(lt,e),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
return outColor;
}`))}let Bn=class extends K{constructor(e,r){super(e,"bool",I.Pass,(i,o,a)=>i.setUniform1b(e,r(o,a)))}};const zn=.4;function Sr(t){t.constants.add("ambientBoostFactor","float",zn)}function Cr(t){t.uniforms.add(new ie("lightingGlobalFactor",(e,r)=>r.lighting.globalFactor))}function Zi(t,e){const r=t.fragment;switch(t.include(br,e),e.pbrMode!==$.Disabled&&t.include(Er,e),t.include(Pn,e),t.include(Xi),r.code.add(s`
...
return max(c.x, max(c.y, c.z));
  ...
  `)}function Yn(t){const e=new Wt,{vertex:r,fragment:i,varyings:o}=e,{output:a,normalType:n,offsetBackfaces:l,instancedColor:c,spherical:u,receiveShadows:d,snowCover:h,pbrMode:v,textureAlphaPremultiplied:g,instancedDoublePrecision:p,hasVertexColors:x,hasVertexTangents:T,hasColorTexture:G,hasNormalTexture:L,hasNormalTextureTransform:z,hasColorTextureTransform:P}=t;if(We(r,t),e.include(pr),o.add("vpos","vec3"),e.include(lt,t),e.include(Bi,t),e.include(Hi,t),e.include(Hn,t),!ft(a))return e.include(ji,t),e;e.include(Un,t),e.include(Wn,t),e.include(jn,t),e.include(qn,t),gt(r,t),e.include(Gt,t),e.include(Ue,t);const F=n===Q.Attribute||n===Q.Compressed;return F&&l&&e.include($i),e.include(rn,t),e.include(Si,t),c&&e.attributes.add(f.INSTANCECOLOR,"vec4"),o.add("vPositionLocal","vec3"),e.include($e,t),e.include(Ni,t),e.include(zi,t),e.include(Gi,t),r.uniforms.add(new te("externalColor",w=>w.externalColor)),o.add("vcolorExt","vec4"),t.terrainDepthTest&&o.add("depth","float"),r.main.add(s`
